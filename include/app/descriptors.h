...
namespace descr {
    ...
    combinedImageSamplerBinding(const uint32_t binding, const uint32_t count = 1) {
    ...
    static vk::DescriptorSetLayoutBinding storageBinding(const uint32_t binding, const uint32_t count = 1) {
        return vk::DescriptorSetLayoutBinding(
                ...
                // All defined shader stages can access the resource
...
public:
    ...
    void
    updateUniformBuffer(const uint32_t binding, const vk::Buffer &uniformBuffer, const uint32_t arrayIndex = 0) const;

    void
    updateStorageBuffer(const uint32_t binding, const vk::Buffer &storageBuffer, const uint32_t arrayIndex = 0) const;
};
