...
public:
    ...
    void bindComputeDescriptorSet(const vk::PipelineLayout &layout, const vk::DescriptorSet &set,
                                  const uint32_t setNumber = 0);

    void bindComputeDescriptorSet(const Pipeline &pipeline, const DescriptorSetAllocation &set,
                                  const uint32_t setNumber = 0);
