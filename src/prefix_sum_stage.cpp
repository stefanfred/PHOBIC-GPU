...
PrefixSumStage::PrefixSumStage(App& app, uint32_t workGroupSizeLocal, uint32_t workGroupSizeOffset) : app(app), workGroupSizeLocal(workGroupSizeLocal), workGroupSizeOffset(workGroupSizeOffset) {
