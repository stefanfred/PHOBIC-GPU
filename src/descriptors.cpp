...
static vk::DescriptorPool createDescriptorPool(const vk::Device& device, const std::vector< vk::DescriptorType>& descriptorTypes) {
...
DescriptorSetAllocation::DescriptorSetAllocation(DescriptorAllocator* allocator, vk::DescriptorSet set, vk::DescriptorSetLayout layout)
